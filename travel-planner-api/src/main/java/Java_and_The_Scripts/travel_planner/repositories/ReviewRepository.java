...
public interface ReviewRepository extends JpaRepository<ReviewEntity, Long> {
    ...
    @Transactional
    @Modifying
    @Query(value = "DELETE FROM ReviewEntity review WHERE review.activityEntity.activityId = :activityIdPassed")
    void deletebyActivityId(@Param("activityIdPassed") Long activityId);
}
